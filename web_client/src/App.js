...
function App() {
  ...
  return (
    <div className="App">
      {renderAddBookForm(newBook, setNewBook, addBook, () =>
        readAndShowBooks(setBooks)
      )}
      <div className="books-container">{renderBooksList(books)}</div>
    </div>
  );
}
...
function renderAddBookForm(
  ...
  return (
    <div className="books-add">
      <input type="text" onChange={(e) => setNewBook(e.target.value)} />
      <button
        onClick={async () => {
